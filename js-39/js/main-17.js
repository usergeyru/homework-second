...
// const number = +prompt("Введите число для проверки на четность");
...
// 	}
// } else {
//   console.log("Ошибка! Проверьте корректность введенных данных");
// }
...
const weightOfParcel = +prompt("Введите вес посылки (в кг.)");
...
if (weightOfParcel <= 0 || isNaN(weightOfParcel)) {
	alert("Некорректный вес посылки");
} else {
  const typeOfDelivery = prompt("Введите тип доставки(Стандарт, Экспресс, Премиум)");
  const basePrice =
	weightOfParcel < 1 ? 5 : weightOfParcel >= 1 && weightOfParcel <= 5 ? 10 : 15;
